...
case "$1" in
  ...
  staging|stg)
    ...
    churros init --user 'churros@churros.com' --password 'elements1' --url 'https://staging.cloud-elements.com' --template ~/cloud-elements/churros-sauce/sauce.json --1pass --1pass-element all
  ;;
  production|prod)
    echo 'Initializing churros to run tests against production...'
    churros init --user 'churros@churros.com' --password 'Elements@123' --url 'https://api.cloud-elements.com' --template ~/cloud-elements/churros-sauce/sauce.json --1pass --1pass-element all
  ;;
  *)
