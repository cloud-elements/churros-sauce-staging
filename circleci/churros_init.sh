...
case "$1" in
  ...
  production|prod)
    echo 'Initializing churros to run tests against staging...'
    churros init --user 'churros@churros.com' --password 'elements1' --url 'https://api.cloud-elements.com' --template ~/cloud-elements/churros-sauce/sauce.json --1pass --1pass-element all
  ;;
  *)
